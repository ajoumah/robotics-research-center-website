...
<body>
    ...
    <div id="home" class="hero-area">
        ...
        <!-- Backgound Image -->
        <div class="bg-image bg-parallax overlay" style="        background-image: url(./img/RobotBackground.jpg)"></div>
        <!-- /Backgound Image -->
        ...
        <div class="home-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="white-text"> Center for <br/> </h1>
                        <h3 class=" white-text"> Machine Learning , Robotics & Computer Vision </h3>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="section-header">
                        <h3>Welecome to Robotics Vision Center</h3>
                        <p class="lead text-justify">Robotics Vision Center of Hasan Kalyoncu University conducts research on applied and theoretical problems related to computer vision,Robotics and machine learning. Members of the center include faculty, graduate and undergraduate students from the Electrical and Electronics Engineering and Computer Engineering departments of Hasan Kalyoncu University.</p>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="section-header text-center">
                    <h2>Why Robotics vision center</h2>
